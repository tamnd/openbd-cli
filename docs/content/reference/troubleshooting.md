...
Most of these come down to network reality or how openbd serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openbd rate-limits like any public site. openbd already paces
...
Where a surface is gated, openbd reads a cookie or token you supply
...
`openbd`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openbd actually did
